...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="${pageContext.request.contextPath}/template/startbootstrap-sb-admin-2-gh-pages/vendor/morrisjs/morris.css" rel="stylesheet">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i> 공지사항</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/EgovPageLink.do?link=jang/com/EgovPageLink/NewFile"><i class="fa fa-dashboard fa-fw"></i> 테스트</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/EgovPageLink.do?link=jang/com/EgovPageLink/NewFile2"><i class="fa fa-dashboard fa-fw"></i> 테스트2</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/EgovPageLink.do?link=jang/com/EgovPageLink/sub1/NewFile"><i class="fa fa-dashboard fa-fw"></i> sub1 테스트</a>
                        </li>
                        <li>
...
<tiles:insertAttribute name="body" />
    ...
    <script src="${pageContext.request.contextPath}/template/startbootstrap-sb-admin-2-gh-pages/vendor/raphael/raphael.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/startbootstrap-sb-admin-2-gh-pages/vendor/morrisjs/morris.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/startbootstrap-sb-admin-2-gh-pages/data/morris-data.js"></script>
