...
// LoggerFactory.getLogger(Table2Controller.class);
//
...
// public String insertForm2(ModelMap model) {
// LOGGER.debug("등록폼");
...
// public String insert2(TableVO vo, ModelMap model) throws Exception {
// LOGGER.debug("등록");
// LOGGER.debug("vo=" + vo);
// // LOGGER.debug("getApplcntNm=" + vo.getApplcntNm());
// System.out.println("vo=" + vo);
